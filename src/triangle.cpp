...
float _splitter;       /* Used to split float factors for exact multiplication. */
float _epsilon;                             /* Floating-point machine _epsilon. */
float _resulterrbound;
float _ccwerrboundA, _ccwerrboundB, _ccwerrboundC;
float _iccerrboundA, _iccerrboundB, _iccerrboundC;
float _o3derrboundA, _o3derrboundB, _o3derrboundC;
...
/*****************************************************************************/
/*                                                                           */
/*  _exactinit()   Initialize the variables used for exact arithmetic.        */
/*                                                                           */
/*  `_epsilon' is the largest power of two such that 1.0 + _epsilon = 1.0 in   */
/*  floating-point arithmetic.  `_epsilon' bounds the relative roundoff       */
/*  error.  It is used for floating-point error analysis.                    */
/*                                                                           */
/*  `_splitter' is used to split floating-point numbers into two half-        */
...
void _exactinit()
{
  ...
  _splitter = 1.0;
  check = 1.0;
  /* Repeatedly divide `_epsilon' by two until it is too small to add to      */
  ...
  _o3derrboundA = (7.0 + 56.0 * _epsilon) * _epsilon;
  _o3derrboundB = (3.0 + 28.0 * _epsilon) * _epsilon;
  _o3derrboundC = (26.0 + 288.0 * _epsilon) * _epsilon * _epsilon;
}
...
/*  result returned is the determinant of a _Matrix.  This determinant is     */
...
float counterclockwiseadapt(vertex pa, vertex pb, vertex pc, float detsum)
{
  ...
  errbound = _ccwerrboundC * detsum + _resulterrbound * Absolute(det);
...
float incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, float permanent)
{
  ...
  errbound = _iccerrboundB * permanent;
  if ((det >= errbound) || (-det >= errbound)) {
    return det;
  }
  ...
  errbound = _iccerrboundC * permanent + _resulterrbound * Absolute(det);
              ...
              vertex pa, vertex pb, vertex pc, vertex pd)
{
  ...
  errbound = _iccerrboundA * permanent;
  if ((det > errbound) || (-det > errbound)) {
    return det;
  }
                   ...
                   float permanent)
{
  ...
  det = estimate(finlength, fin1);
  errbound = _o3derrboundB * permanent;
  if ((det >= errbound) || (-det >= errbound)) {
    return det;
  }
  ...
  errbound = _o3derrboundC * permanent + _resulterrbound * Absolute(det);
              ...
              float aheight, float bheight, float cheight, float dheight)
{
  ...
  errbound = _o3derrboundA * permanent;
  if ((det > errbound) || (-det > errbound)) {
    return det;
  }
...
void triangleinit(struct mesh *m)
{
  ...
  _exactinit();                     /* Initialize exact arithmetic constants. */
}
