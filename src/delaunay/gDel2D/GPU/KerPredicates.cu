...
{
    // Iterate points
    for ( int idx = getGlobThreadIdx(); idx < vertTriVec._num; idx += getThreadNum() )
    {
...
)
{
    ...
    for ( int idx = getGlobThreadIdx(); idx < exactNum; idx += getThreadNum() )
    {
...
)
{
    ...
    for ( int idx = getGlobThreadIdx(); idx < actConsVec._num; idx += getThreadNum() )
    {
